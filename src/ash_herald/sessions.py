...
class SessionManager:
    ...
    def get_session(self, chat_id: str, name: str = None) -> UserSession:
        ...
        return UserSession(chat_id, user_data)
    ...
    def get_all_sessions(self) -> list:
        ...
        return [UserSession(user_data['chat_id'], user_data) for user_data in users_data]
